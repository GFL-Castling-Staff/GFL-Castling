...
void main(dictionary@ inputData) {
        ...
        settings.m_enemyCapacityFactor = 2.3;
        settings.m_enemyAiAccuracyFactor = 0.88;
...
<command class='start_server'
	server_name='[Castling][Massive-6 230%]'
	server_port='1234'
	comment='150% Friend AI, Read server rules in our discord: discord.gg/wwUM3kYmRC, QQ Group: 706234535'
