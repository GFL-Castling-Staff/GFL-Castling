...
class Phase4 : Phase {
	...
	void start() {
		...
		if (!m_continueMode) {
			...
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(681,30,422), 5, "vehicle_driver"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(638,30,522), 5, "vehicle_passenger"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(686,30,521), 5, "vehicle_passenger"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(707,30,460), 5, "vehicle_passenger"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(655,30,435), 5, "vehicle_passenger"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(699,30,391), 5, "vehicle_passenger"));
			m_metagame.addTracker(Spawner(m_metagame, 1, Vector3(617,30,408), 5, "vehicle_passenger"));
