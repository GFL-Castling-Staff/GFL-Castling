...
class BasicCommandHandler : Tracker {
	...
	protected void handleChatEvent(const XmlElement@ event) {
		...
		if (checkCommand(message, "chat")) {
			...
			if (checkCommand(message, "chat10")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat11")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat12")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat13")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat14")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat15")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat16")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat17")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat18")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat19")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
			...
			if (checkCommand(message, "chat20")) {
				const XmlElement@ playerInfo = getPlayerInfo(m_metagame, senderId);
				string strname= playerInfo.getStringAttribute("name");
				dictionary a;
				a["%name"] = strname;
		...
		if (checkCommand(message, "test2")) {
			...
			if (info !is null) {
				...
				string command =
					...
					"	character_id='" + id + "'" +
					"	reward='10000'>" + // multiplier affected..
					"</command>";
				m_metagame.getComms().send(command);
			}
