...
class kill_event : Tracker {
    ...
    dictionary healOnKillWeaponList = {
        ...
        {"gkw_pp19.weapon",3},
        {"gkw_pp19_10105.weapon",3},
        {"gkw_pp19mod3.weapon",3},
        {"gkw_pp19mod3_10105.weapon",3},
        {"gkw_mab38.weapon",3},
        ...
        {"gkw_idw_10707.weapon",3},
        {"gkw_idwmod3.weapon",3},
        {"gkw_idwmod3_2108.weapon",3},
        {"gkw_idwmod3_3205.weapon",3},
        {"gkw_idwmod3_4908.weapon",3},
        {"gkw_idwmod3_10707.weapon",3},
        {"gkw_64type.weapon",3},
        {"gkw_64type_7108.weapon",3},
        {"gkw_64type_8507.weapon",3},
        {"gkw_64typemod3.weapon",3},
        {"gkw_64typemod3_7108.weapon",3},
        {"gkw_64typemod3_8507.weapon",3},
        {"gkw_kp31.weapon",3},
        ...
        {"gkw_ro635_4504.weapon",3},
        {"gkw_ro635mod3_4504.weapon",3},
        {"gkw_owen.weapon",3},
        {"gkw_type82.weapon",3},
        {"gkw_mac10.weapon",3},
        ...
        {"gkw_type80mod3_2504.weapon",8},
        {"gkw_type80mod3_skill.weapon",8},
        {"gkw_type80mod3_2504_skill.weapon",8},
        {"ff_beluga.weapon",15},
	...
	protected void handleCharacterKillEvent(const XmlElement@ event){
        ...
        if ((killer.getIntAttribute("faction_id")) != (target.getIntAttribute("faction_id"))){
            ...
            if(startsWith(c_armorType,"nadebag_t6")){
                ...
                int nadeNewScore = nadeCurrentScore + kill_to_heal_scale;
                // _log("现在有" + nadeNewScore + "分回雷积分");

                if(nadeNewScore >= nadebag_recovery_threshold){
                    g_playerInfo_Buck.addKillSkillCountbyPid(playerId, "nadebag_recovery", kill_to_heal_scale - nadebag_recovery_threshold);
                    ...
                    g_playerInfo_Buck.addKillSkillCountbyPid(playerId, "nadebag_recovery", kill_to_heal_scale);
                }
            }
            else {
                // 未装备nadebag时清除已有分数
