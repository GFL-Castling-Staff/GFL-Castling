...
void main(dictionary@ inputData) {
		...
		settings.m_fellowDisableEnemySpawnpointsSoldierCountOffset = 0;
...
<command class='start_server'
	server_name='[Castling][Normal-2 LV2]'
	server_port='1235'
	comment='(1.0:2.0)Read server rules in our discord: discord.gg/wwUM3kYmRC, QQ Group: 706234535'
