	...
	protected void handleChatEvent(const XmlElement@ event) {
        ...
        if(checkCommand(message,"spt")){
            ...
            if (player.hasAttribute("aim_target")) {
                ...
                if(s=="jr") spawnSoldier(m_metagame,4,0,target,"ar_56_m4sop2jr");
                ...
                if(s=="ljss") spawnSoldier(m_metagame,1,1,target,"sf_alchemist");
                if(s=="xws") spawnSoldier(m_metagame,1,1,target,"sf_weaver");
                if(s=="gangshi") spawnSoldier(m_metagame,1,1,target,"sf_nemeum");
                if(s=="gangshi2") spawnSoldier(m_metagame,1,1,target,"sf_nemeum_swap");
                if(s=="longqi") spawnSoldier(m_metagame,1,1,target,"sf_dragoon");
                if(s=="m16") spawnSoldier(m_metagame,1,1,target,"sf_m16a1");
                if(s=="baka") spawnSoldier(m_metagame,1,1,target,"sf_destroyer");
                ...
                if(s=="paraar") spawnSoldier(m_metagame,1,1,target,"pard_strelet");
                if(s=="tiaotiao") spawnSoldier(m_metagame,1,1,target,"pard_rodelero");
                if(s=="zhs") spawnSoldier(m_metagame,1,1,target,"pard_commander");
                if(s=="police") spawnSoldier(m_metagame,1,1,target,"pard_police");
                if(s=="paradog") spawnSoldier(m_metagame,1,1,target,"pard_dog");
                if(s=="nyto") spawnSoldier(m_metagame,1,1,target,"alina");
                if(s=="teal") spawnSoldier(m_metagame,1,1,target,"teal");
                if(s=="int") spawnSoldier(m_metagame,1,1,target,"sf_intruder");
                if(s=="bgd") spawnSoldier(m_metagame,1,1,target,"pard_doppelsoldner");
                ...
                if(s=="daoniang") spawnSoldier(m_metagame,1,1,target,"sf_brute");
                if(s=="daoniang_s") spawnSoldier(m_metagame,1,1,target,"sf_brute_swap");
                ...
                if(s=="cerberus+") spawnSoldier(m_metagame,1,1,target,"sf_cerberus_plus");
                ...
                if(s=="excute") spawnSoldier(m_metagame,1,1,target,"sf_executioner_queen_of_the_moon");
                if(s=="tareus") spawnSoldier(m_metagame,1,1,target,"tareus");
                if(s=="aileron") spawnSoldier(m_metagame,1,0,target,"aileron");
                if(s=="hunter") spawnSoldier(m_metagame,1,1,target,"sf_hunter");
                if(s=="gly") spawnSoldier(m_metagame,1,1,target,"sf_goliath");
                if(s=="gly2") spawnSoldier(m_metagame,1,1,target,"sf_goliath_plus");
                if(s=="hnb") spawnSoldier(m_metagame,1,1,target,"pard_hannibal");
                if(s=="hnb_f") spawnSoldier(m_metagame,1,0,target,"pard_hannibal");
                if(s=="ladon") spawnSoldier(m_metagame,1,1,target,"ladon");
                if(s=="spd") spawnSoldier(m_metagame,1,1,target,"pard_arachne");
                if(s=="spdc") spawnSoldier(m_metagame,5,1,target,"pard_arachne_clone");
